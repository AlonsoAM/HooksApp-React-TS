...
import {getInitialState, scrambleReducer} from "@/05-useReducer/reducer/scrambleReducer.ts";
...
export const ScrambleWords = () => {
  ...
  useEffect(() => {
    // Activar confetti cuando se adivine una palabra (cuando los puntos aumenten)
    if (points > 0) {
      confetti({
        particleCount: 100,
        spread: 70,
  ...
  const handlePlayAgain = () =>  dispatch({type: 'START_NEW_GAME', payload: getInitialState()})
